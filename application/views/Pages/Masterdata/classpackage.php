...
// End Edit Image //
  ...
  function load_table_class(table_row, table_row_data)
  {
    let text = "";
    for (let i = 0; i < table_row; i++) {
      text += '<tr><th>'+table_row_data[i].schedule_day+'</th><th><button type="button" class="btn btn-icon btn-danger delete btn-sm mb-2-btn" onclick="delete_schedule('+table_row_data[i].schedule_class_id +', '+table_row_data[i].class_id +')"><i class="fas fa-trash-alt sizing-fa"></i></button></th></tr>';
    }
